...
//		System.out.println("4234");
        ...
        if (content != null) {
            dept_list = departmentService.findAllDept(content);
        }
...
//		System.out.println(id);
        if (id != null) {
            Dept dept = departmentService.get_Info(id);
...
//		System.out.println(dept.getId());
        if (id != null) {
            departmentService.update_Info(dept);
            System.out.println(dept.getId());
        } else {
...
//		System.out.println(dept.getName());
    ...
    public void delete(Integer id) {
        System.out.println(id);
        if (id != null) {
            departmentService.delete_Info(id);
        }
    }
}
